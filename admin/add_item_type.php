...
if(isset($_GET["id"])){
    $result = DBHelper::get("select * from item_type where id = {$_GET["id"]}")->fetch_assoc();
}
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card border-right border-bottom border-info">
        ...
        <form method="post" action=" <?php echo (isset($_GET["id"])) ? "model/update_companies.php?type=item&id=".$_GET['id'] : "";?>">
                ...
                while($row = $data->fetch_assoc()){
                    ?>
                      <tr>
                        ...
                        <td class="w-25">
                            <a class="btn-sm btn-warning" href="add_item_type?id=<?php echo $row["id"];?>">Update</a>
                            <!--<a class="btn-sm btn-danger" href="model/delete_companies.php?id=<?php echo $row["id"];?>&type=item">Delete</a>-->
                        </td>
                    </tr>
                    <?php
                }
...
if(DBHelper::set("INSERT INTO `item_type`(`name`) VALUES ('{$name}')")){
