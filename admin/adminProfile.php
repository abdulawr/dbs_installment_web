    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img onclick="ShowImage(this.src)" class="profile-user-img img-fluid img-circle"
                       src="../images/admin/<?php echo $investor["image"];?>"
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Access balance</b> <a class="float-right"><?php echo $access_balance;?></a>
                  </li>
                ...
                <?php
                if($investor["type"] == 2){
                  if ($investor["account_status"] == 0) {
                      ?>
                   <a href="model/changeadminAccountStatus.php?status=1&id=<?php echo $investor["id"];?>"  class="btn btn-danger text-white btn-block"><b>Block It</b></a>
                  <?php
                  }
                  else{
                    ?>
                    <a href="model/changeadminAccountStatus.php?status=0&id=<?php echo $investor["id"];?>"   class="btn btn-warning btn-block"><b>Allow It</b></a>
                   <?php  
                  }
                }
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link " href="#pendingAmount" data-toggle="tab">Accessory Pending Amount</a></li> 
                      ...
                      while ($row = $data->fetch_assoc()) {
                        ?>
                          ...
                          <td>
                              ...
                              elseif($row["type"] == "dbs_shop"){
                                echo '<span class="badge badge-info">DBS Shop</span>';
                              }
                              else{
                          ...
                          <?php
                              ...
                              elseif($row["status"] == 4){
                                echo '<span class="badge badge-warning">DBS Shop Purchase</span>';
                              }
                              else{
                          ...
                          <?php
                              if($row["type"] == "expence"){
                                if($row["exp_type"] == 0){
                                  echo '<span class="badge badge-success">Company Exp</span>';
                                }
                                else{
                                  echo '<span class="badge badge-warning">DBS Shop Exp</span>';
                                }
                              }
                              else{
                                echo '---';
                      ...
                      while ($row = $data->fetch_assoc()) {
                        ?>
                          ...
                          <td>
                              ...
                              elseif($row["type"] == "dbs_shop"){
                                echo '<span class="badge badge-dark">DBS Shop</span>';
                              }
                              else{
                                echo '<span class="badge badge-warning">Expence</span>';
                              }
                          ...
                          <?php
                              ...
                              elseif($row["status"] == 4){
                                echo '<span class="badge badge-dark">DBS shop purchase</span>';
                              }
                              else{
                                echo '<span class="badge badge-info">Company cost</span>';
                              }
          ...
          <div class="tab-pane" id="pendingAmount">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" method="post">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="name" required type="name" class="form-control urdu" id="inputName" placeholder="نام" value="<?php echo $investor["name"];?>">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label urdu">نام</label>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea name="address" required class="form-control urdu" id="inputExperience" placeholder="گھر کا پتہ"><?php echo $investor["address"];?></textarea>
                        </div>
                        <label for="inputExperience" class="col-sm-2 col-form-label urdu">گھر کا پتہ</label>
                      </div>
