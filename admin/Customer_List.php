...
if($type == "1"){
/* ID */
$qry="SELECT * FROM `customer` WHERE id=$query";
}
elseif($type == "2"){
   /* CNIC */ 
   $qry="SELECT * FROM `customer` WHERE cnic=$query";
}
elseif($type == "3"){
    /* Mobile */
    $qry="SELECT * FROM `customer` WHERE mobile=$query";
}
elseif($type == "4"){
   /* Name */ 
   $qry="SELECT * FROM `customer` WHERE name LIKE '%".$query."%'";
}
else{
