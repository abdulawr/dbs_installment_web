...
if($type == "1"){
/* ID */
$qry="SELECT * FROM `shopkeeper` WHERE id=$query";
}
elseif($type == "2"){
   /* CNIC */ 
   $qry="SELECT * FROM `shopkeeper` WHERE cnic=$query";
}
elseif($type == "3"){
    /* Mobile */
    $qry="SELECT * FROM `shopkeeper` WHERE mobile=$query";
}
elseif($type == "4"){
   /* Name */ 
   $qry="SELECT * FROM `shopkeeper` WHERE name LIKE '%".$query."%'";
}
else{
                ...
                if($customer != "null"){
                    if($customer->num_rows > 0){
                     ...
                     <tr>
                        ...
                        <td class="<?php if(!empty($amount) && $amount > 0) {echo 'bg-warning';}?>"><?php echo $amount; ?></td>
                        <td>
                            <a href="ShopkeeperProfile.php?ID=<?php echo $row["id"];?>" class="btn-sm btn-info">View Details</a>
                        </td>
                    </tr>
                        <?php
                        }
