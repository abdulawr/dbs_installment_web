             ...
             <div class="container">
              ...
              <div class="row">
                    ...
                    <div class="row">
                        ...
                        <input name="price" required type="text" class="form-control" placeholder="Enter selling price...." value="<?php echo $stock["selling_price"];?>">
                        </div>
                    </div>
                    <button type="submit" class="btn-sm btn-info mt-3">Generate Invoice</button>
                    </form>
