...
if(isset($_GET["id"])){
    $result = DBHelper::get("select * from mobile_company_dbs where id = {$_GET["id"]}")->fetch_assoc();
}
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card border-right border-bottom border-info">
        ...
        <form method="post" action=" <?php echo (isset($_GET["id"])) ? "model/updateMobileCompany.php?typ=up&id=".$_GET['id'] : "";?>">
    ...
    <section class="content">
      ...
      <div class="card border-right border-bottom border-info">
        ...
        <tbody>
            <?php
            $data=DBHelper::get("select * from mobile_company_dbs order by id asc");
            if($data->num_rows > 0){
                while($row = $data->fetch_assoc()){
                    ?>
                      <tr>
                        ...
                        <td class="w-25">
                            <a class="btn-sm btn-warning" href="mobileCompany?id=<?php echo $row["id"];?>">Update</a>
                            <a class="btn-sm btn-danger" href="model/updateMobileCompany.php?id=<?php echo $row["id"];?>">Delete</a>
                        </td>
                    </tr>
                    <?php
                }
...
if(DBHelper::set("INSERT INTO `mobile_company_dbs`(`name`) VALUES ('{$name}')")){
